    ...
    vim.api.nvim_create_autocmd("FileType", {
        ...
        callback = function()
            ...
            vim.api.nvim_buf_set_keymap(
                ...
                "n",
                "<F7>",
                "<ESC>:w<CR>:split<CR>:te gcc-13 -Wshadow -Wall  -o %:t:r.out %  && time ./%:t:r.out<CR>",
            ...
            vim.api.nvim_buf_set_keymap(
                ...
                "n",
                "<F8>",
                -- "<ESC>:w<CR>:split<CR>:te /usr/bin/clang -Wshadow -Wall -std=c11 -o %:t:r.out % && time ./%:t:r.out<CR>",
                "<ESC>:w<CR>:split<CR>:te /usr/bin/clang -Wshadow -Wall  -o %:t:r.out % -fsanitize=address -fsanitize=undefined -D_GLIBCXX_DEBUG && time ./%:t:r.out<CR>",
                { silent = true, noremap = true }
            )
            vim.api.nvim_buf_set_keymap(
                0,
    ...
    vim.api.nvim_create_autocmd("FileType", {
        ...
        callback = function()
            vim.api.nvim_buf_set_keymap(
                ...
                "n",
                "<F8>",
                "<ESC>:w<CR>:split<CR>:te go run %<CR>",
                { silent = true, noremap = true }
            )
        end,
    })
